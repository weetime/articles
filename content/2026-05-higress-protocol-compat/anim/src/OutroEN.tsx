  ...
  return (
    <Bg>
      <AbsoluteFill style={{alignItems: 'center', justifyContent: 'center', padding: land ? '0 80px' : '0 80px 320px'}}>
        ...
        <div style={{fontSize: 50, fontWeight: 850, lineHeight: 1.25, textAlign: 'center', letterSpacing: -1, marginTop: 10, opacity: l2, transform: `translateY(${(1 - l2) * 24}px)`}}>
          <span style={{color: C.green}}>zero overhead</span> · <span style={{color: C.violet}}>zero client change</span>
        </div>
        ...
        <div style={{fontSize: 30, color: C.ink2, fontWeight: 600, textAlign: 'center', opacity: line, lineHeight: 1.5}}>
          Keep your <b style={{color: C.ink}}>OpenAI / Anthropic SDK</b><br />just point <b style={{color: C.ink}}>base_url</b> at the gateway
        </div>
