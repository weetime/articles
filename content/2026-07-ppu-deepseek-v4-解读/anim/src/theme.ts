...
const DARK = {
  pageGrad:
    'radial-gradient(1000px 560px at 80% -8%, #5b8bd01f, transparent 60%),' +
    'radial-gradient(820px 520px at 4% 106%, #4fb3cf12, transparent 60%),' +
  ...
  off: '#6b7484',
  offDeep: '#4b5360',
  fillViolet: 'linear-gradient(90deg,#5b8bd0,#7fa8dd)',
  fillGreen: 'linear-gradient(90deg,#2bb96a,#46e58c)',
  fillCyan: 'linear-gradient(90deg,#2e94b0,#4fb3cf)',
  fillOff: 'linear-gradient(90deg,#3f4856,#5b6473)',
  prefix: ['#6f9bd8', '#4fb3cf', '#f0a93b', '#ff5d7a'],
};
