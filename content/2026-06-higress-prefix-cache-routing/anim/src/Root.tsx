...
import {TopologyEN} from './TopologyEN';
import {BarRaceEN} from './BarRaceEN';
...
const SCENES: {id: string; comp: React.FC; dur: number}[] = [
  ...
  {id: 'HookEN', comp: HookEN, dur: 95},
  {id: 'HeroEN', comp: HeroEN, dur: 480},
  {id: 'TopologyEN', comp: TopologyEN, dur: 500},
  {id: 'BarRaceEN', comp: BarRaceEN, dur: 410},
  {id: 'OutroEN', comp: OutroEN, dur: 370},
];
